...
You can observe that MPG value for Manual transmission is 24.39 which is significantly higher compared to that of Automatic transmission value of 17.15. The boxplot available in Appendix also concludes the same result
...
plot(mtcars$wt, mtcars$mpg, xlab="Weight", ylab="mpg", main="Relationship between weight & mpg")
